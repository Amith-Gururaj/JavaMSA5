...
class CustomerTest {
	...
	public void getAllCustomerTest() {
		when(custrepo.findAll()).thenReturn(Stream.of(new Customer(1L, "Amith", "Male", 21, "veg"), new Customer(2L, "Simran", "Female", 25, "nonveg")).collect(Collectors.toList()));
		assertEquals(2, ( custserv.getAllCustomer()).size()); 
	}
	
	@Test
	public void addCustomerTest() {
		Customer c1=new Customer(1L, "Amith", "Male", 21, "veg"); 
